    ...
    services: {
      ...
      web: {
        ...
        groups: [
          {
            title: 'Sites web',
            text: 'Je développe des sites web professionnels adaptés à votre image :',
            items: [
          ...
          {
            title: 'E-commerce',
            text: 'Je crée des boutiques en ligne performantes et convertissantes :',
            items: [
        ...
        groups: [
          {
            ...
            text: 'Je réalise des vidéos pensées pour la conversion et la marque :',
            items: [
              'Spots publicitaires',
          ...
          {
            title: 'Bannières web',
            text: 'Je crée des bannières display efficaces et soignées :',
            items: [
              'Bannières statiques',
          ...
          },
          {
            ...
            text: 'Je livre des formats compatibles avec les régies et plateformes :',
            items: [
          ...
          },
          {
            ...
            text: 'Je vous accompagne du brief au livrable final :',
            items: [
    ...
    services: {
      ...
      web: {
        ...
        groups: [
          {
            title: 'Websites',
            text: 'I build professional websites tailored to your brand:',
            items: [
          ...
          {
            title: 'E-commerce',
            text: 'I create high-performing online stores built to convert:',
            items: [
              'WooCommerce stores',
              'Shopify stores',
        ...
        groups: [
          {
            ...
            text: 'I create videos built for brand and conversion:',
            items: [
              'Commercial spots',
          ...
          {
            title: 'Web banners',
            text: 'I design effective, polished display banners:',
            items: [
              'Static banners',
          ...
          },
          {
            ...
            text: 'I deliver formats compatible with ad platforms and networks:',
            items: [
              'Google Ads / Display Network',
              'Meta Ads (Facebook, Instagram)',
          ...
          },
          {
            ...
            text: 'I support you from brief to final delivery:',
            items: [
